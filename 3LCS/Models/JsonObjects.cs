...
namespace ThreeLCS.Models
{
    public class Asset
    {
        ...
        public string? DisplayOriginalScope { get; set; }
    ...
    public class AssetData
    {
        ...
        public string? AssetTypeNameLowercase { get; set; }
        public string? AssetTypePluralNameLowercase { get; set; }
    ...
    public class CloudHostedInstance
    {
        ...
        public Guid StagingActivityId { get; set; }
        public string? StagingDeployedBy { get; set; }
        public string? StagingDeployedOn { get; set; }
    ...
    public class LcsProject
    {
        ...
        public string? Name { get; set; }
        public string? OrganizationName { get; set; }
        public ThreeLCS.Product ProductId { get; set; }
    ...
    public class ProjectUser
    {
        ...
        public string? UserLastAccess { get; set; }
